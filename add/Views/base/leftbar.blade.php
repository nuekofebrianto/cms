        ...
        <div class="mainnav__top-content scrollable-content pb-5">
            ...
            <div class="mainnav__profile mt-3 d-flex3">
                ...
                <div class="mininav-toggle text-center py-2">
                    <img class="mainnav__avatar img-md rounded-circle border" src="{{ asset('nifty/img/profile-photos/1.png') }}" alt="Profile Picture">
                </div>
                ...
                <ul class="mainnav__menu nav flex-column">
                    ...
                    <li class="nav-item has-sub">
                        ...
                        <ul class="mininav-content nav collapse">
                            <li class="nav-item">
                                <a href="../../index-2.html" class="nav-link">Dashboard 1</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <li class="nav-item has-sub">
                        ...
                        <a href="#" class="mininav-toggle nav-link active"><i class="demo-pli-split-vertical-2 fs-5 me-2"></i>
                        ...
                        <ul class="mininav-content nav collapse">
                            <li class="nav-item">
                                <a href="../minimal-navigation/index.html" class="nav-link">Mini Navigation</a>
                            </li>
                            <li class="nav-item">
                                <a href="../push-navigation/index.html" class="nav-link">Push Navigation</a>
                            </li>
                            <li class="nav-item">
                                <a href="index.html" class="nav-link active">Slide Navigation</a>
                            </li>
                            <li class="nav-item">
                                <a href="../reveal-navigation/index.html" class="nav-link">Reveal Navigation</a>
                            </li>
                            <li class="nav-item">
                                <a href="../stuck-sidebar/index.html" class="nav-link">Stuck Sidebar</a>
                            </li>
                            <li class="nav-item">
                                <a href="../pinned-sidebar/index.html" class="nav-link">Pinned Sidebar</a>
                            </li>
                            <li class="nav-item">
                                <a href="../unite-sidebar/index.html" class="nav-link">Unite Sidebar</a>
                            </li>
                            <li class="nav-item">
                                <a href="../sticky-header/index.html" class="nav-link">Sticky Header</a>
                            </li>
                            <li class="nav-item">
                                <a href="../sticky-navigation/index.html" class="nav-link">Sticky Navigation</a>
                            </li>
