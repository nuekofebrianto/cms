        ...
        <div class="header__brand">
            <div class="brand-wrap">
                ...
                <a href="#" class="brand-img stretched-link">
                    <img src="{{ asset('nifty/img/logo.svg')}}" alt="Nifty Logo" class="Nifty logo" width="40" height="40">
                </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-end w-md-450px">
                        ...
                        <div class="d-flex align-items-center border-bottom px-3 py-2">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <span class="text-muted fst-italic"><a href="https://themeon.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c7a6a6b5a8a998a4afa6b1a2bd87a2bfa6aab7aba2e9a4a8aa">[email&#160;protected]</a></span>
                            </div>
                        </div>
